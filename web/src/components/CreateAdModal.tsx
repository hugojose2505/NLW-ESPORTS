          ...
          <Dialog.Title className='text-3xl font-black'>Publique Um Anúncio</Dialog.Title>
            ...
            <form onSubmit={handleCreateAd} className='mt-8 flex flex-col gap-4' >
              <div className='flex flex-col gap-2'>
                ...
                <input id='game' name='game' className='bg-zinc-900 py-3 px-4 rounded text-sm placeholder:text-zinc-500' defaultValue="">
              ...
              <div className='flex flex-col gap-2'>
                ...
                <Input name ="name" id='name' placeholder='Como é chamado dentro do Jogo'/> 
              </div>
              ...
              <div className='flex gap-6'>
                ...
                <label htmlFor='weekDays'> Quando Costuma Jogar?</label>
                  ...
                  <ToggleGroup.Root type='multiple' value={weekDays} className=' grid grid-cols-4 gap-2' onValueChange={ (response)=> setWeekDays( ()=> response)}  > 
